...
<head>
  ...
  <title>Shwe Hinn Thar Store</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">Store Management System</div>
      </a>
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{route('waysales.index')}}">
          <i class="far fa-file-alt"></i>
          <span>Way Sale</span></a>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('sales.index')}}"><i class='fas fa-copy'></i>
             Sale Reports</a>
            <a class="collapse-item" href="{{route('orders.index')}}"><i class='fas fa-copy'></i>
             Order Reports</a>
            <a class="collapse-item" href="{{route('stocks.index')}}"><i class='fas fa-copy'></i>  
            Inventory Reports</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('subcategories.index')}}">Subcategroy</a>
            ...
            <a class="collapse-item" href="{{route('stocks.index')}}">Stock</a>
