...
<body>
	<form method="post" action="{{route('waysales.store')}}" id="jsPrint">
		@csrf
	<div class="container-fluid logo-border">
					...
					<tbody class="text-center">
						...
						@for($i=0 ; $i < $count; $i++)
							<tr>
								...
								<td>{{$quantity[$i]}} pcs</td>
								<td>{{$sale_price[$i]}} Ks</td>
								<td>{{$amount[$i]}} Ks</td>
							</tr>
						@endfor
		...
		<div class="container">
			<div class="row my-2 mb-4">
						...
						<input type="hidden" name="wayout_id" value="{{$wayout_id}}">
