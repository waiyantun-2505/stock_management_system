...
@section('content')
	...
	<h1 class="text-center font-weight-bold text-danger">Credit Sale Return Form</h1>

	<form class="form-group" method="post" action="{{route('credit_sale_update',$credit_sale->id)}}">
		@csrf
		@method('PUT')
		<div class="container-fluid border-dark mt-4">
			<div class="row">
				<div class="col-lg-3 col-md-3 col-sm-3 text-center">
					...
					<label class="h4">{{$credit_sale->branch->name}}</label>

				</div>
				<div class="col-lg-3 col-md-3 col-sm-3 text-center">
					
					<h2 class="font-weight-bold">Customer Name</h2>
					<label class="h4">{{$credit_sale->customer->name}}</label>

				</div>
				<div class="col-lg-3 col-md-3 col-sm-3 text-center">
					
					<h2 class="font-weight-bold">Sale Date</h2>
					<label class="h4">{{$credit_sale->saledate}}</label>
