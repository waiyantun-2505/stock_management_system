			...
			<li class="list-group-item">
				<div class="row">
					<div class="col-md-12 col-lg-12 col-sm-12 text-center">
						<h1><u><span class="text-primary">({{$sales->customer->name}})</span> Sale Detail Info</u></h1>
					</div>
					<div class="col-md-12 col-lg-12 col-sm-12">
						<a href="{{route('sale_branch',$sales->branch_id)}}" class="btn btn-outline-warning">Back</a>
					</div>
				</div>
					...
					<div class="col-md-3 col-sm-3 col-lg-3">
						<div class="card">
							<div class="card-body">
								...
								<p class="card-text">{{$sales->voucher_no}}</p>
							</div>
						</div>
					</div>
					<div class="col-md-3 col-sm-3 col-lg-3">
						<div class="card">
							<div class="card-body">
								...
								<p class="card-text">{{$sales->branch->name}}</p>
							</div>
						</div>
					</div>
					<div class="col-md-3 col-sm-3 col-lg-3">
						<div class="card">
							<div class="card-body">
								...
								<p class="card-text">{{$sales->saledate}}</p>
							</div>
						</div>
					</div>
					<div class="col-md-3 col-sm-3 col-lg-3">
						<div class="card">
							<div class="card-body">
								...
								<p class="card-text">{{$sales->balance}}</p>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="col-md-4 col-lg-4 col-sm-4">
							<div class="card">
								<div class="card-body">
									...
									<p class="card-text">{{$sales->discount}} %</p>
								</div>
							</div>
						</div>
					@endif
					...
					<div class="col-md-4 col-lg-4 col-sm-4">
						<div class="card">
							<div class="card-body">
								...
								<p class="card-text">{{$sales->total_amount}} </p>
							</div>
						</div>
					</div>
