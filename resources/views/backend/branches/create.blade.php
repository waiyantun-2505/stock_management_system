...
<h1 class="text-center">Register New Branch</h1>
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-12 col-md-12">
			<form class="form-group" method="post" action="{{route('branches.store')}}">
			@csrf
				...
				<div class="phone-list">
					...
					<div class="input-group phone-input col-md-5 col-lg-5 col-sm-5">
						...
						<input type="number" name="phone[]" class="form-control @error('phone')  @enderror" placeholder="Enter Phone Number" />
